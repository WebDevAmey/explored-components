export function DisplayCard({
  ...
  return (
    <article className="group/card flex h-full flex-col overflow-hidden rounded-3xl border border-olive-300 dark:border-olive-700 bg-olive-50 dark:bg-olive-950">
