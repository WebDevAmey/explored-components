...
import { components, type ComponentSection } from "@/lib/registry";

const sections: { title: string; section: ComponentSection }[] = [
  { title: "Components", section: "core" },
  { title: "Recreated-components/", section: "recreated" },
];
        ...
        <div className="animate-in animate-delay-3 w-full">
          <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
            {sections.map(({ title, section }) => (
              <div key={section} className="flex flex-col gap-3 items-start relative shrink-0 w-full">
